...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        inicializarApp();
        cargarUsuarios();
        System.out.println(ModelFactoryController.getInstance().getIUsuario().getListaUsuarios().size());
    ...
    public void iniciarSesion(String email, String contrasenia) throws LecturaException {
        ...
        abrirAlerta("logueado correctamente");
    }
    
    
    public void cargarUsuarios() throws CRUDExceptions {
    	ModelFactoryController.deserializarEmpresa();
    }
}
